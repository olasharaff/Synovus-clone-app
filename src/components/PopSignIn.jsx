...
export default function PopSignIn() {
  ...
  return (
    <div>
    <h1 className="text-center my-10 text-4xl text-red-500">Sign In</h1>
      <div className="flex gap-5 lg:flex-wrap flex-wrap-reverse max-w-6xl px-9 mx-auto items-center mb-20">
        ...
        <div className="max-w-md bg-red-500 p-4 rounded-2xl">
          ...
          <form onSubmit={onSubmitSignIn}>
            ...
            <button
              className="bg-white text-red  text-center px-4 py-3 w-full rounded-md my-6 hover:border-2 hover:border-blue-600"
              target="_blank"
            >
              Login
            </button>
